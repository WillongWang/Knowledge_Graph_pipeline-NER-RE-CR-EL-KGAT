...
class BatchEncoding(UserDict):
    ...
    def is_fast(self) -> bool:
        """
        :obj:`bool`: Indicate whether this :class:`~transformers.BatchEncoding` was generated from the results of a
...
class PreTrainedTokenizerBase(SpecialTokensMixin):
    ...
    def pad(
        ...
        .. note::
            ...
            results will use the same type unless you provide a different tensor type with ``return_tensors``. In the
        ...
        if max_length is None and len(ids) > self.model_max_length and verbose:
            if not self.deprecation_warnings.get("sequence-length-is-longer-than-the-specified-maximum", False):
                logger.warning(
                    ...
                    "for this model ({} > {}). Running this sequence through the model will results in "
