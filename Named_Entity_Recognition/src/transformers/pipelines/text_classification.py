...
class TextClassificationPipeline(Pipeline):
    ...
    softmax over the results. If there is a single label, the pipeline will run a sigmoid over the results.
    ...
    def __call__(self, *args, **kwargs):
        ...
        Return:
            A list or a list of list of :obj:`dict`: Each results comes as list of dictionaries with the following keys:
